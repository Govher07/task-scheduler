...
class $TasksTable extends Tasks with TableInfo<$TasksTable, Task> {
  ...
  static const VerificationMeta _effortLevelMeta = const VerificationMeta(
    'effortLevel',
  );
  @override
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('effort_level')) {
      context.handle(
        _effortLevelMeta,
        effortLevel.isAcceptableOrUnknown(
          data['effort_level']!,
          _effortLevelMeta,
        ),
      );
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  @override
  List<DatabaseSchemaEntity> get allSchemaEntities => [goals, tasks, events];
}
...
final class $$TasksTableReferences
  ...
  static MultiTypedResultKey<$EventsTable, List<Event>> _eventsRefsTable(
    ...
    db.events,
    aliasName: $_aliasNameGenerator(db.tasks.id, db.events.taskId),
  );
...
class $$TasksTableFilterComposer extends Composer<_$AppDatabase, $TasksTable> {
  ...
  ColumnFilters<int> get effortLevel => $composableBuilder(
...
class $$TasksTableAnnotationComposer
  ...
  GeneratedColumn<int> get effortLevel => $composableBuilder(
    column: $table.effortLevel,
    builder: (column) => column,
  );
...
class $$TasksTableTableManager
    extends
        RootTableManager<
          ...
          Task,
          PrefetchHooks Function({bool goalId, bool eventsRefs})
        > {
    ...
    : super(
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({goalId = false, eventsRefs = false}) {
            return PrefetchHooks(
              db: db,
              ...
              getPrefetchedDataCallback: (items) async {
                return [
                  if (eventsRefs)
                    await $_getPrefetchedData<Task, $TasksTable, Event>(
                      currentTable: table,
                      referencedTable: $$TasksTableReferences._eventsRefsTable(
                        db,
                      ),
                      managerFromTypedResult: (p0) =>
                          $$TasksTableReferences(db, table, p0).eventsRefs,
                      referencedItemsForCurrentItem: (item, referencedItems) =>
...
final class $$EventsTableReferences
  ...
  static $TasksTable _taskIdTable(_$AppDatabase db) =>
      db.tasks.createAlias($_aliasNameGenerator(db.events.taskId, db.tasks.id));
